...
|   #   | File                                                                                         | Description                     |
| :---: | -------------------------------------------------------------------------------------------- | ------------------------------- |
|   1   | [main.cpp](https://github.com/apwarren/Other/blob/main/BlackJack/main.cpp) | Main driver of my blakcjack program. |
|   2   | [BlackJack.hpp](https://github.com/apwarren/Other/blob/main/BlackJack/blackjack.hpp) | File containing the rules and implementation of a blackjack game |
|   3   | [Card.hpp](https://github.com/apwarren/Other/blob/main/BlackJack/Card.hpp) | File containing the implementation of a single card. Contains value, rank, and suit of a card|
|   4   | [Container.hpp](https://github.com/apwarren/Other/blob/main/BlackJack/Container.hpp) | File containing all instances of Cards. Cards are stored in a vector which can grow or shrink when desired |
|   5   | [Dealer.hpp](https://github.com/apwarren/Other/blob/main/BlackJack/Dealer.hpp) | File containing the rules and actions of a Dealer. The dealer is managed by the computer. It has one hidden card at beginning of game |
|   6   | [Deck.hpp](https://github.com/apwarren/Other/blob/main/BlackJack/Deck.hpp) | File containing all playable and unused cards for the game. User can play with as many decks as desired |
|   7   | [Hand.hpp](https://github.com/apwarren/Other/blob/main/BlackJack/Hand.hpp) | File containing all cards in use by either the player or dealer. Cards can be sorted when desired |
|   8   | [Human.hpp](https://github.com/apwarren/Other/blob/main/BlackJack/Human.hpp) | File containing all actions expected by both the player and dealer. Player and Dealer inherit from this class |
|   9   | [Player.hpp](https://github.com/apwarren/Other/blob/main/BlackJack/Player.hpp) | File containing all the capable actions that can be executed by the player. The user can choose certain actions during a game such as hit or stand.  |
