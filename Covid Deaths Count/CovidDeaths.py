...
ax.bar(X_axis - 0.2, groupedFemCovidDeaths, 0.4, label = 'Females')
ax.bar(X_axis + 0.2, groupedMaleCovidDeaths, 0.4, label = 'Males')
  
ax2.bar(X_axis - 0.2, groupedFemCovidDeaths, 0.4, label = 'Females')
ax2.bar(X_axis + 0.2, groupedMaleCovidDeaths, 0.4, label = 'Males')
